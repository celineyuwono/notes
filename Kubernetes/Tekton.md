...
<ul>
	...
	<img alt="Steps" src="https://i.ibb.co/q9qfB31/Screen-Shot-2020-08-25-at-17-11-04.png" width="600px" height="340px" />
...
<img alt="Task" src="https://i.ibb.co/qmQWLxZ/Screen-Shot-2020-08-25-at-16-55-12.png" width="600px" height="330px" />

2. `kind: Pipeline`

<img alt="Pipeline" src="https://i.ibb.co/JpPgkhP/Screen-Shot-2020-08-25-at-17-49-28.png" width="600px" height="300px" />

3. `kind: TaskRun`

<img alt="TaskRun" src="https://i.ibb.co/GWKknHh/Screen-Shot-2020-08-25-at-17-13-32.png" width="600px" height="350px" />

4. `kind: PipelineRun`

<img alt="PipelineRun" src="https://i.ibb.co/YQXT8ZC/Screen-Shot-2020-08-25-at-17-13-20.png" width="600px" height="330px" />

5. `kind: PipelineResource`

<img alt="PipelineResource" src="https://i.ibb.co/wrQ9kKS/Screen-Shot-2020-08-25-at-16-57-43.png" width="600px" height="330px" />
...
<img alt="CI/CD Pipeline" src="https://i.ibb.co/Twn8FcZ/Screen-Shot-2020-08-25-at-16-52-56.png" width="600px" height="330px" />
<li>
...
<img alt="Tekton Pipelines: example" src="https://i.ibb.co/bRDNz4L/Screen-Shot-2020-08-25-at-15-47-07.png" width="600px" height="300px" />
</ul>
...
<img alt="Build Task" src="https://i.ibb.co/4TXNYZT/Screen-Shot-2020-08-25-at-17-03-51.png" width="600px" height="330px" />
<li><b>Task 2: Deployment Task</b> -> Takes the deployment manifest and create the deployment. </li>
<img alt="Deployment Task" src="https://i.ibb.co/nnS7ft6/Screen-Shot-2020-08-25-at-17-03-42.png" width="600px" height="330px" />
</ol>
...
<img alt="Tekton Pipelines: architecture" src="https://i.ibb.co/ySJ4s7N/Screen-Shot-2020-08-25-at-16-14-20.png" width="600px" height="340px" />
...
### Summary
<img alt="Simplified Overview of Tekton" src="https://i.ibb.co/5MTNhJD/Screen-Shot-2020-08-26-at-12-16-37.png" width="600px" height="385px" />
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjAyNTQzODgsLTEzMjI2OTYzODMsLT
ExNDgxNDM0MjUsLTE5MTkzNjA4ODEsMTI1NzM3MjUzNiwtMTIy
MzUyMjM5LDE3MzMyNzY4MjEsLTE4NTQzODA1NzAsOTk1MTI3MD
Y5LC02MDMxNjE0NzEsLTEyNTcwMDE4NzksLTEwMzcyNzk3Njgs
LTE2MjYyNjEzNjcsMTQ4Mjk5OTAyNSwtODY2MDkzNjE5LC0xMj
